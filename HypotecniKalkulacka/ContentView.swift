...
class MortgageViewModel {
    ...
    /// Přepočítá automatické mimořádné splátky z nájmu.
    /// Simuluje splácení rok po roku a generuje splátky jen dokud dluh > 0.
    func recalculateAutoPayments() {
        extraPayments.removeAll { $0.autoGenerated }
        guard useRentAsExtraPayments else { return }

        let annualRent = monthlyRent * (12 - vacancyMonths)
        ...
        for year in 1...nYears {
            ...
            let manualExtra = extraPayments
                .filter { $0.year == year && $0.isEnabled && !$0.autoGenerated }
                .reduce(0) { $0 + $1.amount }
            ...
            extraPayments.append(ExtraPayment(year: year, amount: annualRent, autoGenerated: true))
        }
    ...
    var mortgageAmount: Double {
        let base = propertyPrice * (1 - ownCapitalPct / 100)
        return includeReconstruction ? base + reconstructionAmount : base
    }
